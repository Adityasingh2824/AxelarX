...
export default function TradeForm({ market }: TradeFormProps) {
  ...
  return (
    <div className="card overflow-hidden">
      ...
      <div className="flex gap-2 mb-6 p-1 glass rounded-xl border border-white/5">
        <motion.button
          whileTap={{ scale: 0.98 }}
          onClick={() => {
            setSide('buy');
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Total */}
        <div className="space-y-2">
          <label className="text-xs text-gray-400 font-medium">Total</label>
          <div className="relative">
            <input
              type="number"
              value={total}
        ...
        <motion.button
          ...
          className={`w-full py-4 rounded-xl font-bold text-base transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden ${
            side === 'buy'
